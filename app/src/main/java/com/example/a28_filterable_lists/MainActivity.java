...
public class MainActivity extends AppCompatActivity {
    ...
    Fabrics[] fabrics = {
            new Fabrics("Cait", "knit", "DBP", "Brushed Polyester/Spandex\n" +
                    "\n" +
            ...
            new Fabrics("Devon", "knit", "hacci sweater", "HACCI SWEATER KNIT\n" +
                    "POLY/SPANDEX\n" +
            ...
            new Fabrics("Jamie", "knit", "DBP", "Brushed Polyester/Spandex\n" +
                    "\n" +
                    "\"Double\" - means the fabric is brushed on both sides\n" +
                    "\"Single\" - means fabric is brushed on one side, smooth on the other. \n" +
                    "96% POLYESTER / 4% SPANDEX\n" +
                    ...
                    "Works very well for dresses, leggings, tops, etc.\n" +
                    "CARE: Wash on cold, tumble dry"),
            new Fabrics("Maize", "knit", "DBP", "Brushed Polyester/Spandex\n" +
                    "\n" +
                    "\"Double\" - means the fabric is brushed on both sides\n" +
                    "\"Single\" - means fabric is brushed on one side, smooth on the other. \n" +
                    "96% POLYESTER / 4% SPANDEX\n" +
                    ...
                    "Works very well for dresses, leggings, tops, etc.\n" +
                    "CARE: Wash on cold, tumble dry"),
            new Fabrics("Serenity", "knit", "Viscose, Bamboo & Spandex", "4-way stretch\n" +
